...
export const RECIPE_IMAGE_MAP: Record<string, RecipeImageMapEntry> = {
  ...
  // Sprint v1.1 child heroes — elementary 15 (recipe_0305–0319)
  recipe_0305: { kind: 'local', key: 'soy_egg_donburi' },
  recipe_0306: { kind: 'local', key: 'tuna_egg_rice_ball' },
  recipe_0307: { kind: 'local', key: 'soboro_rice_ball' },
  recipe_0308: { kind: 'local', key: 'mini_kimbap_mild' },
  recipe_0309: { kind: 'local', key: 'steamed_egg_rice_bowl' },
  recipe_0310: { kind: 'local', key: 'sausage_scramble' },
  recipe_0311: { kind: 'local', key: 'hotcake_breakfast' },
  recipe_0312: { kind: 'local', key: 'banana_milk_cereal' },
  recipe_0313: { kind: 'local', key: 'roasted_sweet_potato_breakfast' },
  recipe_0314: { kind: 'local', key: 'corn_cheese_egg_rice' },
  recipe_0315: { kind: 'local', key: 'potato_soup_bread' },
  recipe_0316: { kind: 'local', key: 'banana_oatmeal_plain' },
  recipe_0317: { kind: 'local', key: 'tuna_mayo_rice_burger' },
  recipe_0318: { kind: 'local', key: 'breakfast_omurice' },
  recipe_0319: { kind: 'local', key: 'tofu_egg_scramble' },

  // Sprint v1.1 child heroes — toddler 16 (recipe_0320–0335)
  recipe_0320: { kind: 'local', key: 'toddler_mashed_tofu_egg_scramble' },
  recipe_0321: { kind: 'local', key: 'toddler_steamed_egg_rice' },
  recipe_0322: { kind: 'local', key: 'toddler_mashed_banana_oatmeal_porridge' },
  recipe_0323: { kind: 'local', key: 'toddler_mashed_sweet_potato_bowl' },
  recipe_0324: { kind: 'local', key: 'toddler_soft_egg_rice_bowl' },
  recipe_0325: { kind: 'local', key: 'toddler_tofu_veg_rice_bowl' },
  recipe_0326: { kind: 'local', key: 'toddler_chopped_chicken_fried_rice' },
  recipe_0327: { kind: 'local', key: 'toddler_small_veg_egg_stir' },
  recipe_0328: { kind: 'local', key: 'toddler_mashed_potato_carrot_soup_rice' },
  recipe_0329: { kind: 'local', key: 'toddler_shredded_chicken_soft_soup' },
  recipe_0330: { kind: 'local', key: 'toddler_soft_tofu_egg_rice_soup' },
  recipe_0331: { kind: 'local', key: 'toddler_mashed_potato_chicken' },
  recipe_0332: { kind: 'local', key: 'toddler_mashed_banana_plain_yogurt' },
  recipe_0333: { kind: 'local', key: 'toddler_small_steamed_sweet_potato' },
  recipe_0334: { kind: 'local', key: 'toddler_stewed_apple_yogurt' },
  recipe_0335: { kind: 'local', key: 'toddler_warm_milk_oatmeal_cup' },
