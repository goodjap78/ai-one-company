...
export const CONVENIENCE_COMPONENT_CATALOG: ConvenienceComponentEntry[] = [
  ...
  C('salad_pack', '샐러드', ['샐러드'], 'vegetable'),
  ...
  C('triangle_kimbap', '삼각김밥', ['삼각김밥'], 'rice_dish'),
  ...
  C('cup_rice', '컵밥', ['컵밥', '즉석밥'], 'rice_dish'),
  C('sandwich', '샌드위치', ['샌드위치'], 'snack'),
  ...
  C('milk_carton', '우유', ['우유'], 'dairy', 'milk'),
  C('ice_cream', '아이스크림', ['아이스크림', '바닐라 아이스크림'], 'dessert'),
  C('bean_sprout_soup', '콩나물국', ['콩나물국'], 'soup'),
  C('hamburger', '햄버거', ['햄버거'], 'snack'),
  C('cup_udon', '컵우동', ['컵우동'], 'noodle'),
