/**
 * Sprint 12 — toddler dinner weekly plan UI copy.
 */

export const TODDLER_DINNER_WEEKDAY_KO = {
  MON: '월',
  TUE: '화',
  WED: '수',
  THU: '목',
...
export const toddlerDinnerWeeklyPlanCopy = {
  screenEyebrow: '유아 저녁',
  screenTitle: '7일 식단',
