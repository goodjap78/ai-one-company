/**
 * Sprint 12 — toddler breakfast weekly plan UI copy.
 * Static strings only. Do not send these values to analytics.
 */

export const TODDLER_BREAKFAST_WEEKDAY_KO = {
  MON: '월',
  TUE: '화',
  WED: '수',
  THU: '목',
...
export const toddlerBreakfastWeeklyPlanCopy = {
  screenEyebrow: '유아 아침',
  screenTitle: '7일 식단',
