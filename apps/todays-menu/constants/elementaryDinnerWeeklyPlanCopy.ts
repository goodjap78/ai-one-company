/**
 * Sprint v1.1 — elementary dinner weekly plan UI copy.
 */

export const ELEMENTARY_DINNER_WEEKDAY_KO = {
  MON: '월',
  TUE: '화',
  WED: '수',
  THU: '목',
...
export const elementaryDinnerWeeklyPlanCopy = {
  screenEyebrow: '초등학생 저녁',
  screenTitle: '7일 식단',
  screenSubtitle: '이번 주 저녁 고민,\n한 번에 해결해보세요.',
