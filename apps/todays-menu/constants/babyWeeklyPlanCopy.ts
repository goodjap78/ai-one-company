/**
 * Baby weekly plan UI copy — parent-facing only. Not medical advice.
 */

export const BABY_WEEKLY_PLAN_WEEKDAY_KO = {
  MON: '월',
  TUE: '화',
  WED: '수',
  THU: '목',
...
export const babyWeeklyPlanCopy = {
  screenTitle: '이번 주 이유식 메뉴',
  ...
  shareText: '이번 주 우리 아이 이유식 메뉴 🍼\n한끼에서 골라봤어요.',
  shareCardTitle: '이번 주 이유식 메뉴',
  shareCardTitleLine2: '',
  ...
  stageShareLine: (stageLabel: string) => `단계 · ${stageLabel}`,
} as const;
